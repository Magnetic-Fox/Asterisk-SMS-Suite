...
16. `tiffTools.py` - helper for text-to-TIFF conversion, resizing and applying resolution information to the TIFF files (also from [Mail2Fax](https://github.com/Magnetic-Fox/Mail2Fax) project)
